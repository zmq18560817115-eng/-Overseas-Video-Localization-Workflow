...
THERMOS_STRUCTURE_ZH = (
    ...
    "下段竖向数显屏（°F 温度）及图标；数显旁椭圆形 recessed 电源键；"
...
THERMOS_STRUCTURE_EN = (
    ...
    "vertical digital temperature display with °F readout and icons on lower body; oval recessed power button beside display; "
...
THERMOS_POUR_ACTION_EN = (
    ...
    "milk pours OUT only from the small circular spout hole in the lid recess into baby bottle below, "
    "matching pour-spout reference photo"
)
...
THERMOS_USAGE_EN = (
    ...
    f"{THERMOS_MILK_SOURCE_EN}. {THERMOS_STRUCTURE_EN}. {THERMOS_POUR_ACTION_EN}"
)
...
THERMOS_PRODUCT_EN = (
    ...
    "light-purple lid release button, nurture wise band, vertical digital °F display, "
    "pour-spout reference photo"
)

# 策划/分镜 visual 一行汇总
THERMOS_VISUAL_RULES_ZH = f"{THERMOS_USAGE_ZH}；{THERMOS_MILK_SOURCE_ZH}；{THERMOS_STRUCTURE_ZH}"
