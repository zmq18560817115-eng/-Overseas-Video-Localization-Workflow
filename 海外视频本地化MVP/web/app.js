...
const ONBOARDING_STEPS = [
  ...
  },
  {
    phase: "素材准备",
    title: "抓取 TikTok 对标",
    desc: "点顶栏「⟳ 一键采集」（或设置 → 素材维护 → 采集并整理）。按当前产品自动打开 Chrome 抓取 TikTok，完成后整理品类与去重。请在弹出窗口完成 TikTok 登录/验证码。",
    workflowStep: null,
  },
  {
    phase: "素材准备",
    title: "整理素材库",
    desc: "点顶栏「素材」打开对标库，确认保留哪些视频；可在设置 → 素材维护里点「拆解素材」做规则拆解，或展开「高级维护」做品类整理与去重。",
    workflowStep: null,
  },
  {
    phase: "创作流程",
